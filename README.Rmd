...
knitr::include_graphics('vignettes/benchmark.png')
```

See the [benchmarks](https://jhelvy.github.io/logitr/articles/benchmark.html) article for details.
...
If you use this package in a publication, please cite the JSS article associated with it! You can get the citation by typing `citation("logitr")` into R:

...
#' script `data-raw/runtimes.R` in the package repository.
#'
#' @format
#' Variable | Description
#' -------- | ---------------------------------------------
...
#' @keywords datasets
#'
#' @source The `data-raw/runtimes.R` script in the [logitr repository](https://github.com/jhelvy/logitr).
#'
#' @examples
#' data(runtimes)
#'
...
#' tractable time. It is generated by the script `data-raw/runtimes_draws.R` in
#' the package repository.
#'
#' @format
#' Variable | Description
#' -------- | ---------------------------------------------
#' `config` | The logitr backend used: `"cpu"`, `"cpp (1 core)"`, or `"cpp (N cores)"`.
#' `time_sec` | The estimation time in seconds.
#' `numDraws` | The number of random draws used during estimation.
#'
#' @docType data
#'
#' @usage data(runtimes_draws)
#'
#' @keywords datasets
#'
#' @source The `data-raw/runtimes_draws.R` script in the [logitr repository](https://github.com/jhelvy/logitr).
#'
#' @examples
#' data(runtimes_draws)
#'

...
sim_mnl_wtp <- readRDS(here::here('examples', 'results', 'sim_mnl_wtp.Rds'))
sim_mnl_pref <- readRDS(here::here('examples', 'results', 'sim_mnl_pref.Rds'))
sim_mxl_wtp <- readRDS(here::here('examples', 'results', 'sim_mxl_wtp.Rds'))
sim_mxl_wtp <- readRDS(here::here('examples', 'results', 'sim_mxl_wtp.Rds'))
```
...
|`randPars`|A named vector whose names are the random parameters and values the distribution: `'n'` for normal or `'ln'` for log-normal.|`NULL`|
...
|`weightsName`|The name of the column that identifies the weights to be used in model estimation. Optional.|`NULL`|

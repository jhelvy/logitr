...
\textbf{This document is not complete and contains many errors}
...
To cite package 'logitr' in publications use:
  ...
  specifications. R package version 1.0.
...
\begin{CodeOutput}
         Estimate StdError    tStat  pVal signif
lambda   0.366584 0.024369  15.0431 0e+00    ***
feat     1.340569 0.359012   3.7341 2e-04    ***
dannon   1.749081 0.199531   8.7660 0e+00    ***
hiland  -8.386651 0.508074 -16.5067 0e+00    ***
yoplait  3.752907 0.470629   7.9742 0e+00    ***
\end{CodeOutput}
\end{CodeChunk}
...
\textbf{Estimate the model}: \textbackslash{}begin\{CodeChunk\}

\textbackslash{}begin\{CodeInput\} R\textgreater{} library(``logitr'')
R\textgreater{} data(yogurt) R\textgreater{} R\textgreater{} mnl.wtp =
logitr( R\textgreater{} data = yogurt, R\textgreater{} choiceName =
``choice'', R\textgreater{} obsIDName = ``obsID'', R\textgreater{}
parNames = c(``feat'', ``dannon'', ``hiland'', ``yoplait''),
R\textgreater{} priceName = ``price'', R\textgreater{} modelSpace =
``wtp'', R\textgreater{} options = list( R\textgreater{} \# Since WTP
space models are non-convex, run a multistart: R\textgreater{}
numMultiStarts = 10, R\textgreater{} \# If you want to view the results
from each multistart run, R\textgreater{} \# set keepAllRuns=TRUE:
R\textgreater{} keepAllRuns = TRUE, R\textgreater{} \# Use the computed
WTP from the preference space model as the starting R\textgreater{} \#
values for the first run: R\textgreater{} startVals =
mnl.pref.wtp\$Estimate, R\textgreater{} \# Because the computed WTP from
the preference space model has values R\textgreater{} \# as large as 8,
I increase the boundaries of the random starting values: R\textgreater{}
startParBounds = c(-5,5))) \textbackslash{}end\{CodeInput\}
...
\begin{CodeOutput}
            Estimate StdError    tStat   pVal signif
lambda      0.392769 0.026619  14.7554 0.0000    ***
feat.mu     0.896037 0.538862   1.6628 0.0965      .
dannon      1.690217 0.193995   8.7127 0.0000    ***
hiland     -8.463696 0.523847 -16.1568 0.0000    ***
yoplait     3.712257 0.475319   7.8100 0.0000    ***
feat.sigma  6.009529 1.436228   4.1842 0.0000    ***
\end{CodeOutput}
\end{CodeChunk}
...
\textbackslash{}begin\{CodeInput\} R\textgreater{} library(``logitr'')
R\textgreater{} data(yogurt) R\textgreater{} R\textgreater{} mxl.wtp =
logitr( R\textgreater{} data = yogurt, R\textgreater{} choiceName =
``choice'', R\textgreater{} obsIDName = ``obsID'', R\textgreater{}
parNames = c(``feat'', ``dannon'', ``hiland'', ``yoplait''),
R\textgreater{} priceName = ``price'', R\textgreater{} randPars =
c(feat=``n''), R\textgreater{} modelSpace = ``wtp'', R\textgreater{}
options = list( R\textgreater{} \# You should run a multistart for MXL
models since they are non-convex, R\textgreater{} \# but it can take a
long time. Here I just use 1 for brevity: R\textgreater{} numMultiStarts
= 1, R\textgreater{} startVals = mxl.pref.wtp\$Estimate, R\textgreater{}
startParBounds = c(-5,5), R\textgreater{} numDraws = 500))
...
Alt: dannon  0.60767184 0.54811495  0.6602219
Alt: hiland  0.02601784 0.01844573  0.0361543
Alt: weight  0.17802325 0.16324483  0.1925427
Alt: yoplait 0.18828707 0.13881972  0.2502116
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
             share.mean  share.low share.high
Alt: dannon   0.6076718 0.55588461 0.65971365
Alt: hiland   0.0260179 0.01799532 0.03740401
Alt: weight   0.1780234 0.14704761 0.20832311
Alt: yoplait  0.1882869 0.16353876 0.21077416
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
             share.mean  share.low share.high
Alt: dannon  0.58484934 0.50522349  0.6540077
Alt: hiland  0.08666403 0.02950048  0.1626655
Alt: weight  0.16062305 0.14157514  0.1781275
Alt: yoplait 0.16786359 0.11967127  0.2304225
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
             share.mean  share.low share.high
Alt: dannon  0.58435544 0.52656969  0.6389182
Alt: hiland  0.08750646 0.03029285  0.1683864
Alt: weight  0.16046566 0.12500750  0.1960403
Alt: yoplait 0.16767244 0.13722497  0.1967524
\end{CodeOutput}
\end{CodeChunk}

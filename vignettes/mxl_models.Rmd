...
```{r, child='rmdchunks/yogurtDataDescription.Rmd'}
```

In the utility models described below, the data variables are represented as follows:

```{r, child='rmdchunks/mnlPrefExampleTable.Rmd'}
```
...
```{r, child='rmdchunks/mnlPrefExample.Rmd'}
```
...
```{r, child='rmdchunks/mnlWtpExample.Rmd'}
```

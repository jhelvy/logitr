...
where the parameters $\alpha$, $\beta_1$, $\beta_2$, $\beta_3$, and $\beta_4$ have units of utility, and the parameters for $x_{j}^{\mathrm{Feat}}$, $x_{j}^{\mathrm{Hiland}}$, $x_{j}^{\mathrm{Yoplait}}$ and $x_{j}^{\mathrm{Dannon}}$ are normally distributed.

...
```{r, child='rmdchunks/utilityPreferenceScaled.Rmd'}
```
...
```{r, child='rmdchunks/utilityPreference.Rmd'}
```
...
```{r, child='rmdchunks/utilityWtpScaled.Rmd'}
```
...
```{r, child='rmdchunks/utilityWtp.Rmd'}
```

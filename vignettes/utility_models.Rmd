...
```{r, child=here::here('vignettes', 'includes', 'utility.Rmd')}
```
...
```{r, child=here::here('vignettes', 'includes', 'utilityPreferenceScaled.Rmd')}
```
...
```{r, child=here::here('vignettes', 'includes', 'utilityPreference.Rmd')}
```
...
```{r, child=here::here('vignettes', 'includes', 'utilityWtpScaled.Rmd')}
```
...
```{r, child=here::here('vignettes', 'includes', 'utilityWtp.Rmd')}
```

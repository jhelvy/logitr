...
```{r, child=here::here('man', 'rmdchunks', 'utility.Rmd')}
```
...
```{r, child=here::here('man', 'rmdchunks', 'utilityPreferenceScaled.Rmd')}
```
...
```{r, child=here::here('man', 'rmdchunks', 'utilityPreference.Rmd')}
```
...
```{r, child=here::here('man', 'rmdchunks', 'utilityWtpScaled.Rmd')}
```
...
```{r, child=here::here('man', 'rmdchunks', 'utilityWtp.Rmd')}
```

...
| $x_{j}^{\mathrm{FEAT}}$     | A dummy variable for whether the newspaper advertisement was shown to the customer.    |
| $x_{j}^{\mathrm{DANNON}}$   | A dummary variable for the "Dannon" brand.   |
| $x_{j}^{\mathrm{HIGHLAND}}$ | A dummary variable for the "Highland" brand. |
| $x_{j}^{\mathrm{YOPLAIT}}$  | A dummary variable for the "Yoplait" brand.  |
<div>

...
\noindent
To specify this model, the user should move `"price"` from the `pars` argument to the `scalePar` argument and set the `modelSpace` argument to `"wtp"` (`"pref"` is the default value):

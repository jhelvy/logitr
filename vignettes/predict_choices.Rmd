...
You can also use WTP space models to predict choice, but you must provide the additional `priceName` argument to the `predictChoices()` function. For example, here are the results from an equivalent model but in the WTP space:

...
# Load libraries for making figure
library(tidyverse)
library(cowplot)
library(ggrepel)

# Load logitr for runtimes data frame
library(logitr)
...
benchmark <- runtimes %>% 
    ...
    theme_minimal_hgrid(font_family = font_main, font_size = 18) +
    theme(
...
ggsave('benchmark.png', benchmark, width = 6, height = 4.5)
```
